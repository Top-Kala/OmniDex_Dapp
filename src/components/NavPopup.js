...
import gas_icon from "../assets/images/popup/gas-station.png";
            ...
            <ul className="_3DgFXcyOkq2iAtWH0tuygf">
              <li className="qurKyclokEqI27YQFICdG">
                ...
                <div>
                  ...
                  <p className="zorFu3tJU8T7A_tRbulRm">Theme for the web</p>
                </div>
              </li>
              <li className="qurKyclokEqI27YQFICdG">
                <div className="_2v_45L7smCuYTlHG8WCvAn">
                  <img height={30} width={30} src={gas_icon} alt="gas" />

                  <h5 style={{ margin: "auto" }}>70</h5>
                </div>

                <div>
                  <h4 className="jM5sqd_NxOiSJHWFeDzFA">Gas Price</h4>
                  <p className="zorFu3tJU8T7A_tRbulRm">In Ethereum chain</p>
                </div>
              </li>
              <li className="qurKyclokEqI27YQFICdG">
                <div className="_2v_45L7smCuYTlHG8WCvAn">
                ...
                <div>
                  ...
                  <p className="zorFu3tJU8T7A_tRbulRm">Choose language</p>
                </div>
              </li>
              <li className="qurKyclokEqI27YQFICdG">
                <a
                ...
                >
                  ...
                  <div>
                    <h4 className="jM5sqd_NxOiSJHWFeDzFA">Tutorials</h4>
                    <p className="zorFu3tJU8T7A_tRbulRm">How to use</p>
                  </div>
                </a>
              </li>
            </ul>
