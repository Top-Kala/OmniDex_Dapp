    ...
    <div className="home__3KnWO">
        ...
        <div className="advantages__SkBVq">
          ...
          <div className="advantage__1vF4S">
            <img
              ...
              width={80}
            />
            <h3 className="advantage__title__Jtk7W">Trade 10000+ assets</h3>
            <p className="advantage__text__1CDT5">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit
            </p>
          </div>
        ...
        <div className="about__info__3eAVO">
          <p className="about__text__3jNbk">
            <span>
              ...
              exchange a token from one chain to another with ease. Featuring
              Ethereum, Smart Chain, Avalanche, Polygon, Fantom, and more by
      ...
      <section className="audits__366o9">
        ...
        <div className="audits__list__3OBjG">
          <div className="_1NVMLAeGTqGbKx__SalZv8" style={{ width: "38vw" }}>
            <img
              height={70}
